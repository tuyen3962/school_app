...
import 'package:school_web_management/common/repo/main_repo.dart';
...
import 'package:school_web_management/routes/app_routes.dart';
import 'package:school_web_management/routes/app_routes_name.dart';

void main() async {
  await MainRepo.initialize();
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: AppRoutes.onGenerateRoute(),
